...
// Copyright (c) 2019, The Salamander Developers
//
...
const uint64_t DIFFICULTY_TARGET                             = 60; // seconds block time

const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 500000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2180631;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(3300000000);
...
For example:
salamanderd --print-genesis-tx --genesis-block-reward-address SMDRv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in Salamanderd. It is used to know what timestamp
...
const char     CRYPTONOTE_NAME[]                             = "Salamander";
...
const int      P2P_DEFAULT_PORT                              =  48110;
const int      RPC_DEFAULT_PORT                              =  48210;
const int      SERVICE_DEFAULT_PORT                          =  48123;
...
const std::string LICENSE_URL                                = "https://github.com/c44c/salamander/blob/development/LICENSE";
...
{
    {  0x15, 0xb2, 0xe4, 0x77, 0xd1, 0x33, 0x03, 0xb2, 0xa8, 0x3c, 0xc4, 0x2a, 0xa9, 0x7c, 0x82, 0x2e  }
};

const char* const SEED_NODES[] = {
  "10.222.10.101:11897",//echo
  "10.222.10.102:11999", //foxtrot
